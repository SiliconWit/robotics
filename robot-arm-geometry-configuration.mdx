...
```text
  Revolute (R)             Prismatic (P)            Spherical (S)
  1 DOF: rotation          1 DOF: translation       3 DOF: rotation

       axis                     axis                  3 axes through
        |                        |                    one point
        |  /--- link 2           |                        |
        | /  arc of              |  =====> link 2     link | link
  link 1 +   rotation      link 1 |  slide            1  (O)  2
        |  \                     |  =====>                |
        |   \--- link 2'         |                    free rotation
        |                        |                    in all directions
  (rotates about axis)    (slides along axis)     (ball-and-socket)
```
