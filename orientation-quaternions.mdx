---
title: "Lesson 3: Orientation and Quaternions"
...
5. **Normalize quaternions** after every few multiplication operations to prevent drift from the unit hypersphere. A simple normalization $\mathbf{q} \leftarrow \mathbf{q} / \|\mathbf{q}\|$ is computationally cheap and maintains accuracy.
